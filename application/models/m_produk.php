...
class m_produk extends CI_Model {
	...
	{
		$this->db->select(["produk.id_produk","produk.nama","produk.id_kategori","kategori.nama as nama_kategori","merk.nama as nama_merk"])
			->from('produk')
			->join('kategori','produk.id_kategori=kategori.id_kategori')
			->join('merk','produk.id_merk=merk.id_merk');
